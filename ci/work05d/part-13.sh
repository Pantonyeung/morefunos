...
mkdir -p "$ROOT/data-room/src/main/kotlin/com/morefun/smt/data/room"
cat > "$ROOT/data-room/src/main/kotlin/com/morefun/smt/data/room/Daos.kt" <<'__MORE_FUN_FILE_EOF__'
